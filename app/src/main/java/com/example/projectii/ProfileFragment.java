...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        slides.add(new SlideModel(R.drawable.mixblue, ScaleTypes.valueOf("Qachi")));
        slides.add(new SlideModel(R.drawable.whiteslide, ScaleTypes.valueOf("Kachi")));
        slides.add(new SlideModel(R.drawable.mixgreen, ScaleTypes.valueOf("Afone")));
        slides.add(new SlideModel(R.drawable.black, ScaleTypes.valueOf("Ejike")));
