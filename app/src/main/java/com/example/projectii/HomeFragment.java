...
public class HomeFragment extends Fragment {
 ...
 CardView expolre;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        slides.add(new SlideModel(R.drawable.whiteslide, ScaleTypes.valueOf("Qachi")));
        slides.add(new SlideModel(R.drawable.mixgreen, ScaleTypes.valueOf("Kachi")));
        slides.add(new SlideModel(R.drawable.mixblack, ScaleTypes.valueOf("Afone")));
        slides.add(new SlideModel(R.drawable.mixblue, ScaleTypes.valueOf("Ejike")));
